...
public class ComparisonUtilityTest {
    ...
    public static String getFolder(String folderName, String baseFolder, boolean absolute) {
        if(absolute) {
    ...
    public static IDatabase loadDatabase(String folderName, String baseFolder, boolean absolute) {
        return loadDatabase(getFolder(folderName, baseFolder, absolute));
    }
