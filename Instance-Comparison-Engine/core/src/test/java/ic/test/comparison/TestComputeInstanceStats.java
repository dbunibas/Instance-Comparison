...
//    private static final String BASE_FOLDER = "/Users/enzoveltri/git/BART/Bart_Engine/misc/resources/redundancy";
    private static final String BASE_FOLDER = "/Users/enzoveltri/Desktop/instance-comparisons/exp1";
    
//    private static final String BASE_FOLDER = "/resources/redundancy/"; //Resource folder

    public void test() {
//        IDatabase database = ComparisonUtilityTest.loadDatabase("bikeshare-10k/initial", BASE_FOLDER);
        IDatabase database = ComparisonUtilityTest.loadDatabase("bikeshare-10k/addRandomAndRedundantRowsInSourceAndTarget/right", BASE_FOLDER, true);
