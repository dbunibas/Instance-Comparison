...
public class TestInstanceSimilarity extends TestCase {
    ...
    public void test() {
        for (String instance : INSTANCES) {
            ...
            IDatabase leftDb = ComparisonUtilityTest.loadDatabase(instance + "/left", BASE_FOLDER, false);
            IDatabase rightDb = ComparisonUtilityTest.loadDatabase(instance + "/right", BASE_FOLDER, false);
