...
public class TestInstanceSimilarityBruteForce extends TestCase {

    private final static Logger logger = LoggerFactory.getLogger(TestInstanceSimilarityBruteForce.class);
...
//        logger.info(result.toString());
//        assertNotNull(result.getTupleMapping());
////        assertEquals(0.6875, result.getTupleMapping().getScore());
//    }
    @Override
