...
public class TestInstanceSimilarityBruteForceCompatibility extends TestCase {

    private final static Logger logger = LoggerFactory.getLogger(TestInstanceSimilarityBruteForceCompatibility.class);

    private IComputeInstanceSimilarity similarityChecker = new ComputeInstanceSimilarityBruteForceCompatibility();
    private static String BASE_FOLDER = "/similarity/";
    ...
    public void test0() {
        ...
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("00/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("00/right", BASE_FOLDER, false);
    ...
    public void test1() {
        ...
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("01/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("01/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertEquals(0, result.getTupleMapping().getLeftNonMatchingTuples().size());
    ...
    public void test2() {
        ...
        ComparisonConfiguration.setInjective(false);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("02/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("02/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
    ...
    public void test3() {
        ...
        ComparisonConfiguration.setInjective(false);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("03/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("03/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
...
//        assertEquals(14.5, result.getTupleMapping().getScore());
    ...
    public void test4() {
        ...
        ComparisonConfiguration.setInjective(false);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("04/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("04/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
    ...
    public void test5() {
        ...
        ComparisonConfiguration.setInjective(false);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("05/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("05/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(0, result.getTupleMapping().getLeftNonMatchingTuples().size());
...
//
    ...
    public void test6() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("06/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("06/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
...
//        assertEquals("3", result.getTupleMapping().getLeftToRightMappingForValue(new NullValue("_N5")).toString());
    ...
    public void test7() {
        ...
        ComparisonConfiguration.setInjective(false);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("07/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("07/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(1, result.getTupleMapping().getTupleMapping().size());
    ...
    public void test8() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("08/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("08/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
    ...
    public void test9() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("09/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("09/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
    ...
    public void test10() {
        ...
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("10/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("10/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(5, result.getTupleMapping().getTupleMapping().size());
    ...
    public void test11_diffnulls() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("11_diffnulls/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("11_diffnulls/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
    ...
    public void test11_samenull() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("11_samenull/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("11_samenull/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
    ...
    public void test12() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("12/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("12/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(1, result.getTupleMapping().getLeftNonMatchingTuples().size());
    ...
    public void test13() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("13/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("13/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(0, result.getTupleMapping().getLeftNonMatchingTuples().size());
...
//        assertEquals((12 + 4 * ComparisonConfiguration.getK()) / 24.0, result.getTupleMapping().getScore());
    ...
    public void test14() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("14/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("14/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(0, result.getTupleMapping().getLeftNonMatchingTuples().size());
    ...
    public void test18() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("18/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("18/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(0, result.getTupleMapping().getLeftNonMatchingTuples().size());
    ...
    public void test19() {
        ...
        ComparisonConfiguration.setInjective(true);
        ComparisonConfiguration.setForceExaustiveSearch(false);
        IDatabase leftDb = ComparisonUtilityTest.loadDatabase("19/left", BASE_FOLDER, false);
        IDatabase rightDb = ComparisonUtilityTest.loadDatabase("19/right", BASE_FOLDER, false);
        InstanceMatchTask result = similarityChecker.compare(leftDb, rightDb);
        logger.info(result.toString());
        assertNotNull(result.getTupleMapping());
        assertEquals(1, result.getTupleMapping().getLeftNonMatchingTuples().size());
...
//        logger.info(result.toString());
//        assertNotNull(result.getTupleMapping());
////        assertEquals(0.7625, result.getTupleMapping().getScore());
//    }
