...
import static ic.test.utility.UtilityTest.getResourcesFolder;
...
public class TestApplications extends TestCase {
    ...
    public void testDataCleaning() {
        String basePath = getResourcesFolder("datasets" + File.separator + "exp-datacleaning" + File.separator + "bus" + File.separator);
...
//            System.out.println(output);
    ...
    public void testDataExchange() {
        String basePath = getResourcesFolder("datasets" + File.separator + "exp-de" + File.separator + "doctors" + File.separator);
        String sizes[] = {"5k", "25k"};
    ...
    public void testDataVersioning() {
        String basePath = getResourcesFolder("datasets" + File.separator + "exp-dataversioning" + File.separator);
